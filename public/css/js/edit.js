...
function changeImage(num) {
  document.getElementById("changeImage_" + num).style.display = "";
}
...
function addForm() {
    ...
    var text3 = document.createTextNode("[追加部品" + i + "]");
    ...
    input5.type = 'text';
    input5.name = 'new_content_' + i;
    input5.id = 'new_content_' + i;
    ...
    label6_1.htmlFor = "new_number_1_" + i;
    ...
    input6_1.name = 'new_number_1_' + i;
    input6_1.id = 'new_number_1_' + i;
    ...
    label6_2.htmlFor = "new_number_2_" + i;
    ...
    input6_2.name = 'new_number_2_' + i;
    input6_2.id = 'new_number_2_' + i;
    ...
    input7.type = 'text';
    input7.name = 'new_color_' + i;
    input7.id = 'new_color_' + i;
    ...
    input8.type = 'number';
    input8.name = 'new_count_' + i;
    input8.id = 'new_count_' + i;
...
function newFormSwitch(num) {
  var div = document.getElementById("new_else_" + num);
  var radio = document.getElementsByName("new_q_" + num);
  if (radio[3].checked) {
      div.style.display = "";
  } else {
      div.style.display = "none";
